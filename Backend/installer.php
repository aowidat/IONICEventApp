...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200316_event_finalrelease2_06b16f447ad2caec4983_20220621203709_archive.zip';
	const ARCHIVE_SIZE		 = '63839273';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '06b16f4-21203709';
    const SECONDARY_PACKAGE_HASH = 'bf62767-21203709';
	const VERSION			 = '1.4.6';
